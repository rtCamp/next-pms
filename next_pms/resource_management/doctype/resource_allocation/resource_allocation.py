...
from next_pms.resource_management.api.project import (
    get_employees_resource_data_for_given_project,
...
class ResourceAllocation(Document):
    ...
    def on_update(self):
        # Clear all type of allocation related cache if something is changed in allocation
        clear_cache()

    def on_trash(self):
        # Clear all type of allocation related cache if something is deleted in allocation
        clear_cache()
...
def clear_cache(doc=None, method=None):
    def clear_cache_job():
        ...
        get_employees_resource_data_for_given_project.clear_cache()
