            ...
            {PROJECT_LIST_COLUMNS.map((column) => {
              ...
              const headerControl = column.sortField ? (
                <button
                  ...
                  className={cn(
                    "flex h-7 min-w-0 items-center gap-1 rounded-sm py-1.5 select-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-outline-gray-3",
