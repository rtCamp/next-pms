...
function ProjectDetailBody() {
  ...
  return (
    <div className="flex flex-1 min-h-0 max-md:overflow-x-auto">
      {editorMatch ? (
        <NotesProvider>
        ...
        <Tabs
          ...
          className="w-3/4 max-md:min-w-full border-0 rounded-none border-r"
          tabs={finalTabs}
          tabIndex={activeTab}
          onTabChange={handleTabChange}
        />
      )}
      <AboutThisProject className="w-1/4 max-md:min-w-60 max-md:shrink-0" />
    </div>
  );
}
