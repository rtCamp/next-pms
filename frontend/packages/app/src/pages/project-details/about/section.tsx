  ...
  return (
    ...
    >
      <Accordion.Header className="w-full flex justify-between items-center px-5 py-3">
        <Accordion.Trigger className="w-full flex items-center gap-3 group flex-1 rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-outline-gray-3">
          <SmallDown
            aria-hidden
