          ...
          children={(field) => (
            <div className="flex flex-col gap-1.5">
              ...
              <TextEditor
                ...
                editorClass="h-40 prose prose-sm max-w-none max-h-[160px] overflow-auto scrollbar-thin rounded-md border border-outline-gray-2 p-2 text-ink-gray-8 focus:outline-none"
              />
            </div>
          )}
        />
