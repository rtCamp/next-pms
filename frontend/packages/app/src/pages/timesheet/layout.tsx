...
function TimesheetLayout() {
  ...
  const [submitApprovalDates, setSubmitApprovalDates] = useState({ startDate: "", endDate: "", totalHours: 0 });

  const handleApproval = (startDate: string, endDate: string, totalHours: number) => {
