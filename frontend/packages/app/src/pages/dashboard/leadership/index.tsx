...
export default function LeadershipDashboard() {
  ...
  return (
    <>
      ...
      <div role="main" className="flex-1 min-h-0 overflow-y-auto scrollbar-thin p-5 space-y-6 max-w-[1200px] mx-auto">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="flex min-w-0 flex-col gap-2">
            <h2 className="text-2xl font-semibold text-ink-gray-8">Hey, {firstName}</h2>
          </div>
        </div>

        <section aria-label="Leadership dashboard" className="grid grid-cols-12 gap-3">
          <WidgetCard className="col-span-4">
            <LeadershipKpiCard kpikey={"revenue"} month={kpiMonth} onMonthChange={setKpiMonth} />
          </WidgetCard>
          <WidgetCard className="col-span-4">
            <LeadershipKpiCard kpikey={"cost"} month={kpiMonth} onMonthChange={setKpiMonth} />
          </WidgetCard>
          <WidgetCard className="col-span-4">
            <LeadershipKpiCard kpikey={"profit_margin"} month={kpiMonth} onMonthChange={setKpiMonth} />
          </WidgetCard>
