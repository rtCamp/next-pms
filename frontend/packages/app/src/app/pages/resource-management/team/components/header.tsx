...
const ResourceTeamHeaderSection = ({ viewData }: { viewData: ViewData }) => {
  ...
  const updateFilters = (resResourceAllocationPermission: PermissionProps) => {
    ...
    updateFilter({
      ...
      projectType:
        projectTypeParam && projectTypeParam.length > 0
          ? projectTypeParam
          : viewData.filters.projectType,
      allocationType:
  ...
  useEffect(() => {
    const viewFilters = _.omit(filters, [
      "start",
      "weekDate",
      "employeeWeekDate",
      "maxWeek",
  ...
  let sectionFilters = [
    ...
    },
    {
      ...
      handleChange: (value: string | string[]) => {
        updateFilter({ projectType: value as string[] });
      },
      handleDelete: (value: string[] | undefined) => {
      ...
      queryParameterDefault: filters.projectType,
    },
    {
