...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ...
    className={mergeClassNames(
      "fixed top-0 z-[1001] flex max-h-screen w-full flex-col-reverse p-2 gap-2 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
...
>(({ className, variant, ...props }, ref) => {
  return (
    <ToastPrimitives.Root ref={ref} className={mergeClassNames(toastVariants({ variant }), className)} {...props} />
  );
});
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title ref={ref} className={mergeClassNames("text-sm font-semibold", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description ref={ref} className={mergeClassNames("text-sm opacity-90", className)} {...props} />
));
