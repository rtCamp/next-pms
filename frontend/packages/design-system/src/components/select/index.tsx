...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={mergeClassNames("py-1.5 pl-8 pr-2 text-sm font-semibold", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator ref={ref} className={mergeClassNames("-mx-1 my-1 h-px bg-muted", className)} {...props} />
));
